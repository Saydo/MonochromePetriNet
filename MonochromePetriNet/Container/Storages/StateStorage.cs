...
namespace MonochromePetriNet.Container
{
    public partial class MonochromePetriNet
    {
        ...
        private class StateStorage : IStateStorage
        {
            ...
            public StateWrapper Add(GraphicsItems.RoundGraphicsItem item)
            {
            ...
            public bool AddMarker(int stateId, GraphicsItems.RoundGraphicsItem item)
            {
                ...
                {
                    state.MarkerGraphics = item;
                }
                state.AddMarker(item.Id);
                return true;
            }
